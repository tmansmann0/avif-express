...
const i18n = createI18n({
	...
	messages: {
		en: {
			...
			bgQuietWindowLabel: "Off-peak processing hours",
			bgQuietWindowDescription: "Only allow bulk background conversions during these lower-traffic hours.",
			bgQuietWindowStartLabel: "Off-peak start",
			bgQuietWindowEndLabel: "Off-peak end",
			bgNoProcessingWindowLabel: "No processing hours",
			bgNoProcessingWindowDescription: "Block background conversions entirely during this time range.",
			bgNoProcessingWindowStartLabel: "No processing start",
			...
			bgReasonDisabled: "Automatic background processing is disabled.",
			bgReasonNoProcessingHours: "We are inside the no processing hours window.",
			bgReasonOutsideOffPeak: "We are outside the off-peak processing hours window.",
			bgReasonSiteBusy: "The site looks active right now, so conversion is being held back.",
			bgCurrentTimeLabel: "Current local time",
			bgNextRunLabel: "Next scheduled run",
			bgNoScheduledRunLabel: "No cron run scheduled",
			bgActiveUsersStatusLabel: "Recent active users",
			bgCronStatusLabel: "Cron scheduled",
